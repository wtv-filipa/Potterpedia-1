          ...
          <section className="pb-5">
            <div className="container pt-5">
              <div className="text-right">
                ...
                <i onClick={buttonAsc} className="fas fa-sort-alpha-up fa-lg pr-3" style={{ color: "black" }}></i>
                <i onClick={buttonDesc} className="fas fa-sort-alpha-down-alt fa-lg" style={{ color: "black" }}></i>
              </div>
              <div className="row">
