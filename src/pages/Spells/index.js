...
const Spells = () => {
    ...
    const onSearch = (e) =>{
       ...
       const filteredSpells = searchTerm ? orderedSpells.filter(spell =>{
                ...
                <div>
                    ...
                    <Container>
                        <div className="container">
                            ...
                            <Input className="mr-3" type="text" ref={searchRef} onKeyUp={onSearch} placeholder="Search for a spell..."  />
                                <i onClick={buttonAsc} className="fas fa-sort-alpha-up fa-lg pr-3" style={{ color: "white" }}></i>
                                <i onClick={buttonDesc} className="fas fa-sort-alpha-down-alt fa-lg" style={{ color: "white" }}></i>
                            </div>
                            <div className="row">
                                {filteredSpells.map(renderSpells)}
                            </div>
                        </div>
                    </Container>
                    <BackTop />
