...
const renderHouses = ({ name, mascot, headOfHouse, houseGhost, founder, school, values, values1, values2, colors, colors1 }, id) =>
  <HousesGeral key={id} id={id} name={name} mascot={mascot} headOfHouse={headOfHouse} houseGhost={houseGhost} founder={founder} school={school} values={values[0]} values1={values[1]} values2={values[2]} colors={colors[0]} colors1={colors[1]} />;
